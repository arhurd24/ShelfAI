            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] text-slate-500 font-medium italic">Ready</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <header className="h-20 border-b border-white/5 flex items-center justify-between px-12">
            <div className="flex items-center gap-6">
                <div className="flex items-center gap-2 px-3 py-1 bg-green-500/10 rounded-full border border-green-500/20">
                    ...
                    <span className="text-[10px] font-bold text-green-500 uppercase tracking-tighter italic">Backend Sync Active</span>
                </div>
            </div>
        </header>
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-12 relative overflow-hidden">
          ...
          {loading ? (
              ...
              <div className="bg-white/[0.03] border border-white/5 rounded-3xl p-12 backdrop-blur-md shadow-2xl">
                  ...
                  <div className="flex gap-3">
                    {activeFile.cardsUrl && (
                        <a 
                            ...
                            target="_blank"
                            className="p-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-indigo-500/20 transition group"
                            title="Download Anki Cards"
                        >
                            <Download className="w-5 h-5 text-slate-300 group-hover:text-indigo-400" />
                        </a>
                    )}
                    <button 
                ...
                <div className="grid grid-cols-3 gap-6 opacity-50">
                    <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl">
                        <p className="text-slate-500 text-[9px] font-black uppercase tracking-widest mb-1 italic text-center">Cloud Storage Secure</p>
                    </div>
                    <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl text-center">
                        <p className="text-slate-500 text-[9px] font-black uppercase tracking-widest mb-1 italic">Intelligence Level: Gemini 2.0</p>
                    </div>
                    <div className="p-6 bg-white/[0.02] border border-white/5 rounded-2xl text-center">
                        <p className="text-slate-500 text-[9px] font-black uppercase tracking-widest mb-1 italic">Source Status: Verified</p>
                    </div>
                </div>
              </div>
            </div>
            ...
            <div className="z-10 text-center">
              ...
              <p className="text-slate-500 text-xs font-bold uppercase tracking-[0.2em] max-w-sm mx-auto leading-loose italic">
                Awaiting new shelf material input.
              </p>
            </div>
          )}
        </div>
            ...
            <footer className="h-24 border-t border-white/5 bg-[#050507] flex items-center px-12 gap-8 z-20">
                <div className="flex items-center gap-4 w-64">
                    ...
                    <div className="overflow-hidden">
                        ...
                        <p className="text-[9px] text-slate-500 uppercase tracking-widest italic">Listening Now</p>
                    </div>
                </div>
                <div className="flex-1">
                   <audio key={activeFile.audioUrl} controls src={activeFile.audioUrl} className="w-full h-8 accent-indigo-500" />
                </div>
            </footer>
        )}
      </main>
